//! Adapters that wrap host crate types as audemsp_common pipeline nodes,
...
use audemsp_media::pipeline::core::{
    FormatSpec, InternalPacket, MediaSink, MediaSource, MediaType, NodeCapability,
    NodeInfo, PipelineNode,
};
#[cfg(feature = "gstreamer")]
use audemsp_media::pipeline::core::{EncodedFragment, FragmentFlags, FrameTiming};
