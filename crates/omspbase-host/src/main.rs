...
use omspbase_common::protocol::{DtlsParameters, Fingerprint, IceCandidate, IceParameters, MediaKind, SignalingMessage, TransportDirection};
use tokio_tungstenite::tungstenite::Message;
use signaling::SignalingClient;
use omspbase_webrtc::{RTCPeerConnectionFactory, RTCConfiguration, RTCIceServer, RTCIceTransportPolicy, RTCSessionDescription, RTCSdpType, RTCAnswerOptions, TrackKind, TrackSender, TrackRef, RTCPeerConnectionState};
...
let app = axum::Router::new()
    ...
    // PipelineEngine: P2P path only — SFU uses omspbase-webrtc (C12)
    ...
    // SFU produce (mediasoup) — via omspbase-webrtc abstraction
    if config.sfu_produce {
        ...
        // Step 3: Create RTCPeerConnection via omspbase-webrtc (NOT webrtc-rs)
        ...
        // B3: Extract DTLS fingerprint via omspbase-webrtc API (not SDP parsing)
        ...
        // B5: Spawn I420 frame sender using write_raw_i420 (no omspbase-codec needed)
