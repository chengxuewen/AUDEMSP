...
//!
//! Tests the integration between Host-side omspbase-webrtc
...
/// 4. Create RTCPeerConnection via omspbase-webrtc
...
async fn e2e_sfu_host_webrtc_connect() {
    ...
    let host_handle = tokio::spawn(async move {
        ...
        // Create PeerConnection via omspbase-webrtc
...
/// Full pipeline with real video frames sent via omspbase-webrtc.
...
async fn e2e_sfu_full_pipeline() {
    ...
    let host_handle = tokio::spawn(async move {
        ...
        // Create PeerConnection with omspbase-webrtc
        let factory = RTCPeerConnectionFactory::new();
        let pc = factory
