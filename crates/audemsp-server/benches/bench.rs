//! AUDEMSP Server benchmarks — stdlib-only, CI-friendly.
//!
//! Run with: `cargo bench -p audemsp-server`
//!
...
use audemsp_server::monitor::{monitor_router, SharedMetrics};
...
fn main() {
    println!("=== AUDEMSP Server Benchmarks ===\n");
