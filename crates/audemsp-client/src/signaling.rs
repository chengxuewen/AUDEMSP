//! WebSocket signaling client — connects to audemsp-server /ws endpoint.
//!
                        ...
                        Some(Ok(Message::Text(text))) => {
                            match serde_json::from_str::<SignalingMessage>(&text) {
                                Ok(SignalingMessage::Sdp { sdp, room_id, .. }) => {
                                    ...
                                    let sdp_parsed: audemsp_webrtc::RTCSessionDescription =
                                    ...
                                    if sdp_parsed.sdp_type != audemsp_webrtc::RTCSdpType::Offer {
