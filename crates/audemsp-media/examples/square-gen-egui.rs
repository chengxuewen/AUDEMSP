//! AUDEMSP SquareGenerator Demo with egui
//!
//! Usage:
//!   cargo run -p audemsp-media --example square-gen-egui
//!
...
use audemsp_media::backend::LibyuvTransform;
