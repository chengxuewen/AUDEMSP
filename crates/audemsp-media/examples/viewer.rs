...
// audemsp-media viewer — VideoFrame transform demo with egui (grid + single view)
// Usage: cargo run -p audemsp-media --example viewer --features backend-native
...
use eframe::egui;
use audemsp_media::base::buffer::{I420Buffer, VideoBuffer};
use audemsp_media::base::rotation::VideoRotation;
use audemsp_media::backend::NativeTransform;
use audemsp_media::pixel_format::PixelFormat;
use audemsp_media::transform::VideoTransform;
...
fn main() -> Result<(), eframe::Error> {
    eframe::run_native(
        "audemsp-media Video Frame Viewer",
        eframe::NativeOptions {
            viewport: egui::ViewportBuilder::default()
                .with_inner_size([1200.0, 800.0])
                .with_title("audemsp-media Video Frame Viewer"),
            ..Default::default()
        },
