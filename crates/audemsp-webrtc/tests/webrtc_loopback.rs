...
//! Run with:
//! ```bash
//! cargo test -p audemsp-webrtc --test webrtc_loopback
//! ```
...
fn loopback_sdp_exchange_succeeds() {
    ...
    rt.block_on(async {
        ...
        use audemsp_webrtc::peer_connection::RTCSignalingState;
...
fn loopback_close_connects_gracefully() {
    ...
    rt.block_on(async {
        ...
        // Verify closed state
        use audemsp_webrtc::peer_connection::RTCPeerConnectionState;
        assert!(
            matches!(
