...
pub async fn exchange_sdp(
    pc1: &audemsp_webrtc::peer_connection::RTCPeerConnection,
    pc2: &audemsp_webrtc::peer_connection::RTCPeerConnection,
) -> Result<(), RTCError> {
    // 1. PC1 creates offer
...
pub async fn create_connected_pair(
    ...
    (
        audemsp_webrtc::peer_connection::RTCPeerConnection,
        audemsp_webrtc::peer_connection::RTCPeerConnection,
    ),
    RTCError,
> {
