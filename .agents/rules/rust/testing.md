...
- **No examples/ in library-only crates** (e.g., mediaservo-core). Application crates and feature crates (e.g., mediaservo-media) should have examples.
