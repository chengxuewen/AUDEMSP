...
> MediaServo 提供两种客户端形态：Client（桌面 GUI 全功能）和 Host（Headless 远端）。

---

## 对比总览

| 维度 | MediaServo Client | MediaServo Host |
|------|-----------------|----------------|
...
### 特点
- 单一二进制 `mediaservo-host` (~25 MB, GStreamer + libwebrtc 静态链接)
