...
> AUDEMSP 提供两种客户端形态：Client（桌面 GUI 全功能）和 Host（Headless 远端）。

---

## 对比总览

| 维度 | AUDEMSP Client | AUDEMSP Host |
|------|-----------------|----------------|
...
### 特点
- 单一二进制 `audemsp-host` (~25 MB, GStreamer + libwebrtc 静态链接)
