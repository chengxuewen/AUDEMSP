#!/usr/bin/env bash
# pixi-init.sh — Bootstrap MediaServo pixi development environment
...
echo "=== MediaServo pixi environment setup ==="
...
# MediaServo: crates.io mirror for China (rsproxy.cn by ByteDance)
...
echo ""
echo "=== MediaServo pixi environment ready ==="
